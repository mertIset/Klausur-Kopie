...
public interface QuotesService {
   ...
   */
  UpdatableQuote getQuote(int index);

  /**
   * The method returns all Chuck Norris quotes from the QUOTES list.
   * @return All Chuck Norris quotes.
   */
  List<UpdatableQuote> getAllQuotes();

  /**
   * The method adds a Chuck Norris quote into the QUOTES list.
   * @param index - Determines the position where the quote is inserted into list.
   * @throws IllegalArgumentException - Throws IllegalArgumentException if index is out of range.
   */
  void addQuote(int index, String quote);

  /**
   * The method updates (replaces) a Chuck Norris quote from the QUOTES list.
   * @param index - Determines the position in the list of the element to update.
   * @throws IllegalArgumentException - Throws IllegalArgumentException if index is out of range.
   */
  void updateQuote(int index, String quote);
